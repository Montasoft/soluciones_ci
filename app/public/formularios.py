...
#    correo = EmailField("email", [validators.Required(message= 'El correo electronico es requerido'), validators.Email(message='Ingrese un email valido')])
    telefono = IntegerField("teléfono", [validators.InputRequired(message= 'El número de teléfono es requerido'),validators.NumberRange(min=3000000000, max=3999999999, message='Ingrese su número de teléfono')])
